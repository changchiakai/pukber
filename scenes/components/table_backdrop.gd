...
func _draw() -> void:
	...
	draw_polyline(outer + PackedVector2Array([outer[0]]), Color("d0a652"), 4.0, true)
	...
	draw_arc(centre, 128, 0.0, TAU, 64, Color("2d8b70", 0.55), 2.0, true)
	draw_arc(centre, 132, 0.0, TAU, 64, Color("071d20", 0.65), 1.0, true)
