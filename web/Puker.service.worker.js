...
/** @type {string} */
const OFFLINE_URL = 'Puker.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Puker.html","Puker.js","Puker.offline.html","Puker.icon.png","Puker.apple-touch-icon.png","Puker.audio.worklet.js","Puker.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Puker.wasm","Puker.pck"];
