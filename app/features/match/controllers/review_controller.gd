...
func _ready() -> void:
	...
	PokerUI.label(self, "復盤", Rect2(94, 50, 600, 56), 42, PokerUI.GOLD)
...
func _draw_review(review: Dictionary, index: int) -> void:
	var panel := PokerUI.panel(self, Rect2(94, 212 + index * 180, 1248, 168), Color("112b29"), PokerUI.GOLD)
	...
	PokerUI.cards(panel, review.hole, Vector2(748, 12), 2, 0.82)
	PokerUI.cards(panel, review.board, Vector2(900, 14), 5, 0.66)
	PokerUI.label(panel, "建議：%s" % review.recommendation, Rect2(22, 88, 1160, 30), 21)
	var detail := PokerUI.label(panel, review.reason, Rect2(22, 124, 1160, 36), 16, PokerUI.MUTED)
