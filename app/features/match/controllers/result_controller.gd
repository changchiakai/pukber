...
func _ready() -> void:
	...
	PokerUI.accent_button(self, "AI 復盤：3 個關鍵決策", Rect2(94, 795, 450, 60), App.show_review).name = "OpenReview"
	PokerUI.accent_button(self, "重新開始", Rect2(730, 795, 300, 60), App.start_match).name = "Restart"
